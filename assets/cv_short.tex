...
\vskip 1em
Technical Expertise: R, Stata, Latex  (advanced)
Python, ArcGIS, MATLAB (basic)

\vskip 1em
Skills and Methods:
Causal Inference;
Data manipulation, visualization, and modeling;
Econometric analysis and experimental design using difference-in-differences (DiD), instrumental variables (IV), regression discontinuity design (RDD);
