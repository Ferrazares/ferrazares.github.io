...
\usepackage[left=1.1in, right=.75in, top=1in, bottom=.75in]{geometry}
\usepackage{graphicx}
\usepackage{dcolumn}
\usepackage{booktabs}
\usepackage{float}
...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \texttt{toshio.ferrazares@hunter.cuny.edu}
...
\begin{enumerate}
    \item  "\href{https://www.sciencedirect.com/science/article/pii/S0094119023000086}{Monitoring Police with Body-Worn Cameras: Evidence from Chicago}"

          \emph{Journal of Urban Economics}, 2024.
          % \vskip .5em
          % \hspace*{2em}\textbullet\quad Awarded "Best Second Year Paper Award" at UC Santa Barbara Economics

    \item "\href{https://onlinelibrary.wiley.com/doi/abs/10.1002/pam.70045}{Have U.S. Gun Buyback Programs Misfired?}," with Joseph~J.~Sabia and D.~Mark~Anderson.

          \emph{Journal of Policy Analysis and Management}, 2025.
          % \vskip .5em

          % \hspace*{1em}\textbullet\hspace*{.2em} Media Coverage:
    ...
    \item "\href{https://michaeltopper.netlify.app/media/jmp_michael_topper.pdf}{The Unintended Consequences of Policing Technology: Evidence from ShotSpotter}", with Michael~Topper, Forthcoming at \emph{Journal of Human Resources}.
          % \vskip .5em
...
\begin{enumerate}
    ...
    \item  "\href{https://ferrazares.github.io/assets/FERRAZARESjmp.pdf}{Shift Structure and Cognitive Depletion: Evidence from Police Officers}"


    \item “Drinking Water Contaminants and Infant Health”, with Katherine~Grooms, Heather~Royer, and Kevin~Schnepel.
    \item "Barriers to Police Hiring", with Michael~Topper.
    \item “Extended Shifts and Productivity: Evidence from 12-Hour Shifts”, with Michael~Topper.
    \item “The Stock and Flow of Police Officers in the US”, with Michael~Topper.
...
\vskip 2em
\hspace{-2em}\textbf{HONORS AND GRANTS}\vskip .5em
\vskip .5em

\begin{tabular}{ ll }
    2025       & Arnold Ventures Grant for \emph{Extended Shifts and Productivity} (Co-PI), \$195,505 \\
...
Texas Economics of Crime Workshop (TxECW) \\

2024 \\
Southern California Applied Economics Conference (UC Irvine)\\
\hspace*{2em}\myarrow\emph{Best Paper Award} for \emph{Shift Structure and Cognitive Depletion}\\
All California Labor Economics Conference (UC Los Angeles)\\
WEAI Graduate Student Workshop\\

2023 \\
Western Economic Association International\\
All California Labor Economics Conference (UC Santa Barbara)\\
...
%     \\
%     2025-        & Teaching Assistant, Introduction to Econometrics                   \\
...
Referee Service: \textit{
    Journal of Labor Economics, Economic Inquiry, International Review of Law \& Economics
}
\end{document}
...
\clearpage
\vskip 2em
\hspace{-2em}\textbf{Abstracts}\vskip .5em
\vskip .5em
"\href{https://ferrazares.github.io/assets/FERRAZARESjmp.pdf}{Shift Structure and Cognitive Depletion: Evidence from Police Officers}", Job Market Paper.
...
"\href{https://michaeltopper.netlify.app/media/jmp_michael_topper.pdf}{The Unintended Consequences of Policing Technology: Evidence from ShotSpotter}", with Michael~Topper, \emph{Revisions requested at The Journal of Human Resources}.
...
"\href{https://www.nber.org/system/files/working_papers/w28763/w28763.pdf}{Have U.S. Gun Buyback Programs Misfired?}" with Joseph~J.~Sabia and D.~Mark~Anderson, Forthcoming at \emph{Journal of Policy Analysis and Management}. NBER Working Paper \#28763.
