...
\usepackage[left=1.1in, right=1in, top=.75in, bottom=.5in]{geometry}
\usepackage{graphicx}
\usepackage{dcolumn}
\usepackage{booktabs}
\usepackage{float}
...
"The Unintended Consequences of Policing Technology: Evidence from ShotSpotter", with Michael~Topper, \emph{Under Review}.
\vskip 1em

"Have U.S. Gun Buyback Programs Misfired?" with Joseph~J.~Sabia and D.~Mark~Anderson, Revisions Requested at \emph{Journal of Policy Analysis and Management}. NBER Working Paper \#28763.
\vskip 1em

“Drinking Water Contaminants and Infant Health”, with Katherine~Grooms, Heather~Royer, and Kevin~Schnepel.
